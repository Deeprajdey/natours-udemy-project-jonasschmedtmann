...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiZGVlcHJhamRleSIsImEiOiJjazlza2Y4dWQxNHUyM2VxaGU0ZW16YWNxIn0.xZtgqXdzjawNwqVb7ag2Hw";
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      ...
      closeButton: false,
      closeOnClick: false
    }).setLngLat(loc.coordinates).setHTML("<div>Day ".concat(loc.day, ": ").concat(loc.description, "</div>")).addTo(map); // Extend map bounds to include current location
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              window.setTimeout(_alerts.hideAlert, 5000);
...
if (bookBtn) bookBtn.addEventListener("click", function (e) {
  e.target.textContent = "Processing..."; //const tourId = e.target.value;
